	...
	<section class="container py-lg-5">
		...
		<div class="row">
			<div class="col-lg-12 mt-4">
				<div class="panel">
			      <div class="panel-heading" style="font-size: 12px;">Your Devices:
			      	<button type="button" class="od" data-toggle="modal" data-target="#new-device" style="font-size: 18px; float: right; margin-top: -6px; background-color:#0db3cd;">New Device</button>
			      </div>
