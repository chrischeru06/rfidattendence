  ...
  <table class="table">
    ...
    <tbody class="table-secondary">
      <?php
        ...
        if (isset($_POST['log_date'])) {
          ...
          if ($_POST['time_sel'] == "Time_in") {
            ...
            if ($_POST['time_sel_start'] != 0 && $_POST['time_sel_end'] == 0) {
                $mouvement = $_POST['time_sel_start'];
                $_SESSION['searchQuery'] .= " AND timein='".$mouvement."'";
            }
            ...
            if ($_POST['time_sel_end'] != 0) {
                $call = $_POST['time_sel_end'];
                $_SESSION['searchQuery'] .= " AND timein BETWEEN '".$mouvement."' AND '".$call."'";
            }
          }
          //Time-out filter
          if ($_POST['time_sel'] == "Time_out") {
            ...
            if ($_POST['time_sel_start'] != 0 && $_POST['time_sel_end'] == 0) {
                $mouvement = $_POST['time_sel_start'];
                $_SESSION['searchQuery'] .= " AND timeout='".$mouvement."'";
            }
            elseif ($_POST['time_sel_start'] != 0 && $_POST['time_sel_end'] != 0) {
                $mouvement = $_POST['time_sel_start'];
            }
            ...
            if ($_POST['time_sel_end'] != 0) {
                $call = $_POST['time_sel_end'];
                $_SESSION['searchQuery'] .= " AND timeout BETWEEN '".$mouvement."' AND '".$call."'";
            }
          }
          //Card filter
          if ($_POST['card_sel'] != 0) {
        ...
        $sql = "SELECT * FROM mouvement WHERE ".$_SESSION['searchQuery']." ORDER BY id DESC";
